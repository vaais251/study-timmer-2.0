...
const AuthPage: React.FC = () => {
    ...
    const handleGoogleSignIn = async () => {
        ...
        if (data.url) {
            ...
            setNotification("Your browser may be blocking automatic sign-in. Please click the button below to continue.");
        } else {
                    ...
                    {googleSignInUrl ? (
                        <div className="text-center my-4 animate-fadeIn">
                            <a 
                                ...
                                target="_top"
                                className="w-full max-w-[300px] mx-auto flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition-colors"
                            >
